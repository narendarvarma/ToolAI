  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-3 text-center text-white">Base64 Encoder/Decoder</h1>
        <p className="text-gray-400 text-base text-center mb-8">Encode and decode Base64 strings</p>
