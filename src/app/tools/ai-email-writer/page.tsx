...
export default function AIEmailWriter() {
  const toolContent = getToolContent("ai-email-writer")
  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] py-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <ToolContent content={toolContent} toolName="AI Email Writer" toolPath="/tools/ai-email-writer" />

        {/* Related Tools */}
        <RelatedTools currentToolPath="/tools/ai-email-writer" currentCategory={toolContent.category} />
